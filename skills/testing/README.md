...
| [`playwright-test-generator`](./playwright-test-generator/) | Generate and execute Playwright E2E tests for .NET web apps. Analyzes source code (routes, controllers, Razor views, page models) to generate C# Playwright tests with Page Object Models. Auto-detects NUnit/MSTest/xUnit, creates a CI-runnable test project, and produces a generation report |
